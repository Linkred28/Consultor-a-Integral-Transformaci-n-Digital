...
const VideoTile: React.FC<VideoTileProps> = ({ video, onVideoSelect }) => {
  const imageSrc = video.imageUrl || `https://picsum.photos/id/${video.imageId}/600/400`;
  ...
  return (
    ...
    >
      <div className="video-tile-image-wrapper">
        <img src={imageSrc} alt={video.title} loading="lazy" className="aspect-video object-cover" />
